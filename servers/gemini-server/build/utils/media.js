 ...
 */
export async function fetchAsInlineData(url, mimeHint) {
    try {
 ...
 */
export function validateMimeType(mimeType, mediaType) {
 ...
 */
export function validateDataSize(base64Data, maxSizeMB = 20) {
 ...
 */
export function validateBufferSize(buffer, maxSizeMB = 20) {
    const sizeMB = buffer.byteLength / (1024 * 1024);
    return sizeMB <= maxSizeMB;
}
